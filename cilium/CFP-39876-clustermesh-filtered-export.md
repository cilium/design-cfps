...
- global-namespaces - List of namespaces that are "allowlisted for export". The ciliumendpoints and ciliumidentities inside the allowlisted namespaces are exported to remote clusters.
